...
int main() {
    ...
    // Fill DP table for strictly increasing sequences
    ...
    for (int n = 1; n <= M; n++) {
        ...
        for (int peak = 1; peak <= n; peak++) {
            ...
            // Number of ways to form strictly increasing part ending at peak
            // This is the same as number of strictly increasing sequences with sum 'remaining' 
            // ending with any value < peak
            long long increasing_ways = prefix[remaining][peak - 1];
            
            // Number of ways to form strictly decreasing part starting from peak
            // Due to symmetry, this equals the strictly increasing part
