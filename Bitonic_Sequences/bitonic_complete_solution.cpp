...
int main() {
    ...
    for (int n = 1; n <= M; n++) {
        ...
        for (int peak = 1; peak <= n; peak++) {
            ...
            if (remaining > 0) {
                // Number of ways to form non-decreasing part ending at peak
                ...
                // Number of ways to form non-increasing part starting from peak
                // Due to symmetry, this equals the non-decreasing part
